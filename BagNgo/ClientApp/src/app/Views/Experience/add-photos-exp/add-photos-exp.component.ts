...
@Component({
  selector: 'app-add-photos-exp',
  templateUrl: './add-photos-exp.component.html',
  styleUrls: ['./add-photos-exp.component.css']
})
export class AddPhotosExpComponent implements OnInit {
