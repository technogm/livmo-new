...
@Component({
  selector: 'app-add-dish-photos',
  templateUrl: './add-dish-photos.component.html',
  styleUrls: ['./add-dish-photos.component.css']
})
export class AddDishPhotosComponent implements OnInit {
