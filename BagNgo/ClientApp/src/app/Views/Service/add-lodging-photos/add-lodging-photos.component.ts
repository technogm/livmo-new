...
@Component({
  selector: 'app-add-lodging-photos',
  templateUrl: './add-lodging-photos.component.html',
  styleUrls: ['./add-lodging-photos.component.css']
})
export class AddLodgingPhotosComponent implements OnInit {
